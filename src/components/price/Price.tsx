...
const Price = () => {
  return (
    <div className="container">
      <div className="text-[#867373] max-w-[80%] w-[80%] m-auto">
        <p className="font-kur text-[40px] text-center uppercase">
          цена работы
        </p>
        ...
        <Accordion className="grid grid-cols-1 gap-5" type="single" collapsible>
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent className="text-[16px] grid1">
              <p>
                Удобно, когда в любой момент можно позвонить или написать юристу
                и поставить задачку для оперативной отработки. Мы предлагаем
              ...
              <p>
                4. Платеж по договору можно выбирать в течение год а с момента
                его внесения.
              </p>

              {/* <ol className="list-decimal ml-5 grid1">
                <li>За вами закрепляется ответственный юрист.</li>
                <li>
                  Ваши вопросы отрабатываются в приоритетном порядке и в
                  кратчайший срок.
                </li>
                <li>
                  Вы получаете скидку в 25% от цен на все услуги, указанные на
                  сайте, кроме судов.
                </li>
                <li>
                  Платеж по договору можно выбирать в течение год а с момента
                  его внесения.
                </li>
              </ol> */}
              <ButtonsGroup />
